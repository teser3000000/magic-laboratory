...
public class IngredientSelector : MonoBehaviour
{
    ...
    public ReactiveProperty<IIngredient> _currentInteroperableObjectReact { get; private set; } = new ReactiveProperty<IIngredient>();
    ...
    {
        if (TryGetInteroperableObject(out IIngredient item))
        {
    ...
    private bool TryGetInteroperableObject(out IIngredient item)
    {
