...
namespace UnitySimpleLiquid
{
    ...
    public class SplitController : MonoBehaviour
    {
        ...
        public ReactiveProperty<bool> IsSplitingReactive { get; private set; } = new ReactiveProperty<bool>(true);
        private CompositeDisposable disposables = new CompositeDisposable();

        private void CheckSpliting()
        {
            if (IsSpliting != IsSplitingReactive.Value) IsSplitingReactive.Value = IsSpliting;
        ...
        private RaycastHit FindLiquidContainer(Vector3 splitPos, GameObject ignoreCollision)
        {
            ...
            var ray = new UnityEngine.Ray(splitPos, Vector3.down);
        ...
        private Vector3 TryGetSlopeEdge(Vector3 slope, RaycastHit hit)
        {
            ...
            Ray backwardsRay = new UnityEngine.Ray(reverseRayPos, -slope);
